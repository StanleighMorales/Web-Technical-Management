                            ...
                            <div className="space-y-1">
                                {statuses.map((status) => (
                                    <button
                                        ...
                                        className={`flex items-center justify-between w-full px-3 py-2 text-sm rounded-md transition-colors ${selectedStatus === status.value
                            ...
                            <div className="space-y-1">
                                {conditions.map((condition) => (
                                    <button
                                        ...
                                        className={`flex items-center justify-between w-full px-3 py-2 text-sm rounded-md transition-colors ${selectedCondition === condition.value
                                            ? "bg-blue-50 text-blue-700 font-medium"
                                            : "text-gray-700 hover:bg-gray-100"
                                            }`}
                                    >
